  ...
  switch (action.type) {
    ...
    case FILTER_DIETS:
      ...
      return {
        ...state,
        recipes:
          action.payload === "allDiets" ? filterRecipeVar : recipesFilter,
      };
    case PAGE_DETAIL:
      return {
        ...state,
    ...
    case CREATED_EXISTING:
      const recipesCreated = state.recipesOriginal;
      const created =
        action.payload === "created"
          ? recipesCreated.filter((e) => e.created)
          : recipesCreated.filter((e) => !e.created);
      return {
        ...state,
        recipes: action.payload === "All" ? state.recipesOriginal : created,
      };
